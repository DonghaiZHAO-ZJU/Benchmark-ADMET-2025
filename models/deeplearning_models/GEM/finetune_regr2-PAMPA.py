...
def get_label_stat(dataset):
    ...
    iqr = q3-q1
    return median, iqr, np.min(labels), np.max(labels)
...
def main(args, seed=2024):
    ...
    print('Train median/iqr/min/max %s/%s/%s/%s' % get_label_stat(train_dataset))
    print('Valid median/iqr/min/max %s/%s/%s/%s' % get_label_stat(valid_dataset))
    print('Test median/iqr/min/max %s/%s/%s/%s' % get_label_stat(test_dataset))
