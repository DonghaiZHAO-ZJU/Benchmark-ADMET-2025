...
def finetune(args):
    ...
    mol_dataset = MoleculeDataset(root_path=args.data_path, dataset = args.dataset, dataset_type=None, use_scaler=True)
    ...
    best_train, best_val, best_test, best_train1, best_val1, best_test1, best_train2, best_val2, best_test2 = trainer.fit(model, train_loader, val_loader, test_loader, loader=loader, model_path=f'../model/model.pth')
