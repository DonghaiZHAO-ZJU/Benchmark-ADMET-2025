...
from torch_geometric.nn import AttentionalAggregation, GraphMultisetTransformer
...
class GNN(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr, batch, x_feat=None):
        ...
        graph_representation = self.feat_lin(graph_representation)
