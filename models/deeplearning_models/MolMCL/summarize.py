...
def main(args):
    ...
    overall_best_score_list = []
    if 'AC' in result_path or 'ac' in result_path:
        split_types = ['ac']
    for split_type in split_types:
        ...
        for data_name in sorted_data_name:
            ...
            if raw_best_score_list:
                ...
                overall_best_score_list.append(np.mean(best_score_list))
                if best_score_list:
        ...
        print()
    print('average score:', np.mean(overall_best_score_list))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--result_path', type=str, required=True, help='Path to the result file')
