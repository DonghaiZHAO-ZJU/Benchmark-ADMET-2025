  ...
  for split_method in "${split_methods[@]}"; do
    for task in "${all_tasks[@]}"; do
      ...
      if [[ " ${classification_tasks[@]} " =~ " ${task} " ]]; then
        chemprop_train --data_path /root/data1/admet_models_validation/ChemPropFP-main/data/${task}_${split_method}_${seed}/${task}_${split_method}_${seed}_training.csv \
                       --separate_val_path /root/data1/admet_models_validation/ChemPropFP-main/data/${task}_${split_method}_${seed}/${task}_${split_method}_${seed}_valid.csv \
                       --separate_test_path /root/data1/admet_models_validation/ChemPropFP-main/data/${task}_${split_method}_${seed}/${task}_${split_method}_${seed}_test.csv \
                       --dataset_type classification \
                       --save_dir /root/data1/admet_models_validation/ChemPropFP-main/result/${task}_${split_method}_${seed}_all_result \
                       --metric auc \
